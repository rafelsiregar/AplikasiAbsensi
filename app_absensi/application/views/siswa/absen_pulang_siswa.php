...
<body>
    ...
    <div class = "container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h3 style="margin-top:60px">Anda Sudah Pulang</h3>
                    <p style="margin-top:50px">
                    Anda telah melakukan absen pulang pada pukul <?php echo $jam_pulang?> WIB.
                    </p>
                <h3><marquee>Terima kasih telah melakukan absensi pulang, sampai jumpa esok hari.</marquee></h3>
                </div>
            </div>
    </div>
