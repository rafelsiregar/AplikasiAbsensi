...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <a href="<?php echo base_url("siswa/")?>" class="nav-link">STATUS ABSEN</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class = "container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h3 style="margin-top:60px">Anda Sudah Masuk</h3>
                    <p style="margin-top:50px">Anda telah melakukan absen masuk pada pukul <?php echo $jam_masuk?>
                    WIB</p>
                <h3><marquee>Terima kasih telah melakukan absensi masuk, jangan lupa melakukan absensi pulang</marquee></h3>
                </div>
            </div>
    </div>
