    ...
    <div class = "container">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <p style="margin-top:50px">Selamat datang di Aplikasi Simulasi Absensi Online <br>
                    Anda dapat melakukan absensi di dengan mengeklik tombol <b>ABSEN MASUK</b> untuk absen masuk, dan <br>
                    <b>ABSEN PULANG</b> untuk absen pulang pada smartphone anda. <br>
                </p>
                <h3><marquee>Selamat menggunakan aplikasi ini</marquee></h3>
                </div>
            </div>
    </div>
